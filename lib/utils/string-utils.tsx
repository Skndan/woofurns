...
export function toStateDescription(str: string) {
    switch (str) {
        case "START":
            return "You are starting the instance.";
        case "STOP":
            return "You are stopping the instance.";
        case "HIBERNATE":
            return "You are hibernating the instance.";
        case "REBOOT":
            return "You are rebooting the instance.";
        default:
            return "You are terminating the instance.";
    }
}
